    ...
    <>
      ...
      <div className="intro-section">
        <p className="intro-section-text">
          ...
          and flavors. Our restaurant is built around the idea of bringing
          people together with the love of food and great company. We offer a
            ...
            <Row className="mt-4 rowRow">
              ...
              <Col md={6}>
                <div className="press-links">
                  ...
                  <p>
                    Our recent meal at HungryHub was nothing short of
